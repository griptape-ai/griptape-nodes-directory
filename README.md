...
* **[Hyper3D Rodin](https://github.com/griptape-ai/griptape-nodes-library-rodin)** - generate 3D models from text prompts or images using Hyper3D's Rodin API with support for text-to-3D, image-to-3D, multi-image generation, and multiple output formats (GLB/USDZ)
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-rodin)
...
* **[Black Forest Labs](https://github.com/griptape-ai/griptape-nodes-library-blackforestlabs)** - interact with Black Forest Labs' FLUX APIs, enabling high-quality image generation and editing capabilities
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-blackforestlabs)
...
* **[Decart](https://github.com/griptape-ai/griptape-nodes-library-decart)** - generate images from text prompts and transform existing images using Decart's Lucy Pro models with text-to-image and image-to-image capabilities
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-decart)
...
* **[Google AI](https://github.com/griptape-ai/griptape-nodes-library-googleai)** - generate images from text prompts using Google's Imagen & Gemini 2.5 Flash Image models with comprehensive customization options
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-googleai)
...
* **[LoRA Training](https://github.com/griptape-ai/griptape-nodes-lora-training-library)** - Generate training datasets and train LoRA models using [kohya-ss/sd-scripts](https://github.com/kohya-ss/sd-scripts)
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-lora-training-library)
...
* **[Luma AI](https://github.com/griptape-ai/griptape-nodes-library-luma)** - generate and modify images using Luma's Photon models with support for image generation, modification, and intelligent aspect ratio reframing
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-luma)
...
* **[Minimax](https://github.com/griptape-ai/griptape-nodes-library-minimax)** - generate high-quality images from text prompts with multiple aspect ratios, custom dimensions, and batch generation support
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-minimax)
...
* **[SAM3](https://github.com/griptape-ai/griptape-nodes-library-sam3)** - promptable segmentation for images (and videos) using Facebook's SAM3 model
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-sam3)
...
* **[Topaz Labs](https://github.com/griptape-ai/griptape-nodes-library-topazlabs)** - denoise and enhance images with Topaz Labs models via their API
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-topazlabs)
...
* **[Kling](https://github.com/griptape-ai/griptape-nodes-library-kling)** - generate videos from text prompts, images, or extend existing videos
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-kling)
...
* **[RunwayML](https://github.com/griptape-ai/griptape-nodes-library-runwayml)** - generate videos from images and text prompts
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-runwayml)
...
* **[Blender](https://github.com/griptape-ai/griptape-nodes-library-blender)** - Nodes and MCP server for Blender
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-blender)
...
* **[Neo4j](https://github.com/griptape-ai/griptape-nodes-library-neo4j)** - Nodes for managing and accessing a [Neo4j graph database](https://neo4j.com/)
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-neo4j)

### 🔧 Miscellaneous

* **[FireCrawl](https://github.com/griptape-ai/griptape-nodes-library-firecrawl)** - generate text by crawling the web with FireCrawl

  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/griptape-ai/griptape-nodes-library-firecrawl)
...
* **[Storyboard](https://github.com/ian-griptape-ai/griptape-nodes-library-storyboard)** - create storyboard grid layouts from multiple images with customizable columns, padding, and output resolutions
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/ian-griptape-ai/griptape-nodes-library-storyboard)
...
* **[Suno (Unofficial)](https://github.com/ian-griptape-ai/griptape-nodes-libary-suno)** - generate AI-powered music tracks using the Suno API with custom lyrics, styles, vocal preferences, and multiple model versions
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/ian-griptape-ai/griptape-nodes-libary-suno)
...
* **[SendGrid](https://github.com/ian-griptape-ai/griptape-nodes-library-sendgrid)** - send emails through the SendGrid API with support for plain text, HTML content, and multiple attachment types
  ...
  [![Add to Griptape Nodes](images/add_to_griptape_nodes.png)](https://nodes.griptape.ai/#library-management?git=https://github.com/ian-griptape-ai/griptape-nodes-library-sendgrid)
